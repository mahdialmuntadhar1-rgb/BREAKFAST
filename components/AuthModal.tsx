      ...
      <div className="relative w-full max-w-md backdrop-blur-2xl bg-dark-bg/90 border border-white/20 rounded-3xl p-8 shadow-glow-primary text-start rtl:text-right">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <button onClick={handleEmailAuth} disabled={isLoading || !email || !password} className="w-full py-3 rounded-xl bg-primary text-white font-semibold disabled:opacity-50">{activeTab === 'signin' ? t('auth.signIn') : t('auth.createAccount')}</button>
          </div>

  ...
  return (
    <section className="lg:col-span-2">
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
        ...
        <SocialFeed posts={posts} isLoading={isLoading} isLoggedIn={isLoggedIn} onLoginRequired={onProtectedAction} />

        {postsHasMore && (
          <div className="mt-6 flex justify-center">
            <button onClick={onLoadMorePosts} className="px-6 py-3 rounded-xl bg-white/10 border border-white/20 text-white hover:bg-white/20 transition-all">
